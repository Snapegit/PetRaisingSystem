  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="领养时间" prop="lingyangshijian">
          <el-input v-model="ruleForm.lingyangshijian" 
              placeholder="领养时间" clearable  :readonly="ro.lingyangshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="领养时间" prop="lingyangshijian">
              <el-input v-model="ruleForm.lingyangshijian" 
                placeholder="领养时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="领养时长" prop="lingyangshizhang">
          <el-select v-model="ruleForm.lingyangshizhang" placeholder="请选择领养时长">
            <el-option
                v-for="(item,index) in lingyangshizhangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="领养时长" prop="lingyangshizhang">
	      <el-input v-model="ruleForm.lingyangshizhang"
                placeholder="领养时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.jinkuangzhaopian" label="近况照片" prop="jinkuangzhaopian">
          <file-upload
          tip="点击上传近况照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.jinkuangzhaopian?ruleForm.jinkuangzhaopian:''"
          @change="jinkuangzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.jinkuangzhaopian" label="近况照片" prop="jinkuangzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.jinkuangzhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
                                                                                                                                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="近况反馈" prop="jinkuangfankui">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="近况反馈"
                  v-model="ruleForm.jinkuangfankui" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jinkuangfankui" label="近况反馈" prop="jinkuangfankui">
                    <span>{{ruleForm.jinkuangfankui}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	lingyangshizhang : false,
	jinkuangzhaopian : false,
	jinkuangfankui : false,
	sfsh : false,
	shhf : false,
      },
            ruleForm: {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lingyangshijian = true;
            continue;
	            	            ...
	            	            if(o=='lingyangshizhang'){
            this.ruleForm.lingyangshizhang = obj[o];
	    this.ro.lingyangshizhang = true;
            continue;
          }
	            	            if(o=='jinkuangzhaopian'){
            this.ruleForm.jinkuangzhaopian = obj[o];
	    this.ro.jinkuangzhaopian = true;
            continue;
          }
	            	            if(o=='jinkuangfankui'){
            this.ruleForm.jinkuangfankui = obj[o];
	    this.ro.jinkuangfankui = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                                                                              }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                                        ...
                                                                                                                                                                        this.lingyangshizhangOptions = "十天,三十天,半年,一年".split(',')
                                                                                                    },
                                                                                                        // 多级联动参数
                                                                                                                                    info(id) {
      this.$http({
        url: `qingkuangfankui/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `qingkuangfankui/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qingkuangfankuiCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                                                        ...
                                                                                                                        jinkuangzhaopianUploadChange(fileUrls) {
                this.ruleForm.jinkuangzhaopian = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
