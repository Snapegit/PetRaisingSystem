  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.chongwuzhaopian" label="宠物照片" prop="chongwuzhaopian">
          <file-upload
          tip="点击上传宠物照片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.chongwuzhaopian" label="宠物照片" prop="chongwuzhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.chongwuzhaopian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingming = true;
            ...
            this.ruleForm.chongwuzhaopian = obj[o];
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                        ...
                                        this.chongwuxingbieOptions = "雌,雄".split(',')
                                                                                                                      },
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
	...
	this.ruleForm.chongwuxiangqing = this.ruleForm.chongwuxiangqing.replace(reg,'../../../ssmvwq50/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                ...
                this.ruleForm.chongwuzhaopian = fileUrls;
				this.addEditUploadStyleChange()
            },
                        	addEditStyleChange() {
	  this.$nextTick(()=>{
