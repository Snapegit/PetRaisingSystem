      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="饲料名称" prop="siliaomingcheng">
          <el-input v-model="ruleForm.siliaomingcheng" 
              placeholder="饲料名称" clearable  :readonly="ro.siliaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饲料名称" prop="siliaomingcheng">
              <el-input v-model="ruleForm.siliaomingcheng" 
                placeholder="饲料名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="适用宠物" prop="shiyongchongwu">
          <el-input v-model="ruleForm.shiyongchongwu" 
              placeholder="适用宠物" clearable  :readonly="ro.shiyongchongwu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="适用宠物" prop="shiyongchongwu">
              <el-input v-model="ruleForm.shiyongchongwu" 
                placeholder="适用宠物" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="饲料种类" prop="siliaozhonglei">
          <el-select v-model="ruleForm.siliaozhonglei" placeholder="请选择饲料种类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="饲料种类" prop="siliaozhonglei">
	      <el-input v-model="ruleForm.siliaozhonglei"
                placeholder="饲料种类" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="饲料配料" prop="siliaopeiliao">
          <el-input v-model="ruleForm.siliaopeiliao" 
              placeholder="饲料配料" clearable  :readonly="ro.siliaopeiliao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="饲料配料" prop="siliaopeiliao">
              <el-input v-model="ruleForm.siliaopeiliao" 
                placeholder="饲料配料" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出厂公司" prop="chuchanggongsi">
          <el-input v-model="ruleForm.chuchanggongsi" 
              placeholder="出厂公司" clearable  :readonly="ro.chuchanggongsi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出厂公司" prop="chuchanggongsi">
              <el-input v-model="ruleForm.chuchanggongsi" 
                placeholder="出厂公司" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.siliaotupian" label="饲料图片" prop="siliaotupian">
          <file-upload
          tip="点击上传饲料图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.siliaotupian" label="饲料图片" prop="siliaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.siliaotupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                            <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                              ...
                                                                              this.$http({
              url: `option/siliaozhonglei/zhonglei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `siliaogoumai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.siliaogoumaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
