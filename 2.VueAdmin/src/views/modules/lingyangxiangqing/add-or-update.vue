  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="领养时间" prop="lingyangshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.lingyangshijian" label="领养时间" prop="lingyangshijian">
              <el-input v-model="ruleForm.lingyangshijian" 
                placeholder="领养时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="领养地点" prop="lingyangdidian">
          <el-input v-model="ruleForm.lingyangdidian" 
              placeholder="领养地点" clearable  :readonly="ro.lingyangdidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="领养地点" prop="lingyangdidian">
              <el-input v-model="ruleForm.lingyangdidian" 
                placeholder="领养地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lingyangshijian = true;
            continue;
	            	            ...
	            	            if(o=='lingyangdidian'){
            this.ruleForm.lingyangdidian = obj[o];
	    this.ro.lingyangdidian = true;
            continue;
          }
	            	            	                    }
                                                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `lingyangxiangqing/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lingyangxiangqingCrossAddOrUpdateFlag = false;
                  this.parent.search();
